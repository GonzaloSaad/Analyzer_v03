from lexical_analyzer.Lexer import Lexer  # Se importa la clase Lexer, que tiene el nucleo de un Analizador Lexico.
from lexical_analyzer.Lexeme import Lexeme  # Se importa la clase Lexeme, que tiene la logica de un lexema.
...
class FunctionLexer():
    ...
    def __init__(self, inputString, variable='x', *args):
        ...
        self.__lexer = Lexer(inputString)  # Se intancia la clase Lexer.
